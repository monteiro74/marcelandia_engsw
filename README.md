...
| Data    | Conteúdo |
| ------- | ------- |
| Aula 1: (05/agosto) | Apresentação e introdução à disciplina. Conceitos iniciais. Engenharia de software, Análise de sistemas, analista de sistemas, processos de software, RUP. [Slides da aula 1](https://docs.google.com/presentation/d/1lj4virPGjnFFgsluvyEMNhHiBMecFaFqQPevuB6hNYs/view#slide=id.p1). |
...
| Aula 7: (12/agosto) | **Avaliação 1** (prova escrita). Início do projeto de sistemas com ferramenta IDE RAD. Outros assuntos: [Conceitos de VM](https://www.youtube.com/watch?v=K756DRm2Vho), usos de VM (virtual machine), instalação e configuração de VMs. Criação de projeto em IDE RAD (início da avaliação 3), desenvolvimento de menu, grids e forms. Revisão do BD e script de BD. Criação de interfaces com o Draw.IO.|
...
### 9.1. Outros artigos em sites/blogs
